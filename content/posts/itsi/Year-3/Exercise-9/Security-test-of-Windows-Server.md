...
> This is an HTL Donaustadt laboratory report converted from the original document. The [original PDF](https://github.com/0xveya/goobering/blob/master/itsi/y3/ex9/Sicherheitstests%20von%20Windows%20Server.pdf) and [bibliography](https://github.com/0xveya/goobering/blob/master/itsi/y3/ex9/zotero.bib) are available on GitHub.
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/menthing.png" title="Original report cover image" >}}
**Subject:** ITSI  
**Class:** 3AHITN  
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/topo.png" title="Figure 1: Complete network topology of the exercise" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/user.png" title="Figure 2: Verifying the creation of the users" >}}
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/groups.png" title="Figure 3: Verifying the creation of the groups" >}}
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/shares.png" title="Figure 4: Verifying the creation of the shares" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/hydrasmb.png" title="Figure 5: Obtaining the password for the smb share" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/smb1.png" title="Figure 6: Inspecting the first Negotiate Protocol Request" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/smb2.png" title="Figure 7: Viewing the Negotiate Protocol Response" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/smb3.png" title="Figure 8: Viewing the second Negotiate Protocol Request" >}}

- Now the client responds with its own list of supported capabilities.

{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/smb4.png" title="Figure 9: Viewing the second Negotiate Protocol Response" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/smb5.png" title="Figure 10: Viewing the Session Setup Request" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/smb6.png" title="Figure 11: Viewing the Session Setup Response" >}}

- The client sends another `Session Setup Request` with `NTLMSSP_AUTH`, including the domain name, user name, and session key.

{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/smb7.png" title="Figure 12: Viewing the second Session Setup Request" >}}

- If the authentication fails, the server responds with `STATUS_LOGON_FAILURE`.

{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/smb8.png" title="Figure 13: Viewing the second Session Setup Response" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/smb9.png" title="Figure 14: Viewing the successful Session Setup Response" >}}
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/smb10.png" title="Figure 15: Viewing the Tree Connect Request" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/smb11.png" title="Figure 16: Viewing the Tree Connect Response" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/hydranordp.png" title="Figure 17: Hydra showing that it's not compiled with freerdp support" >}}
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/freerdpnonono.png" title="Figure 18: Showing that the libfreerdp3 package is installed but not found" >}}

Using my script, I can now obtain the credentials and generate a command to connect to the server.

{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/rdpburteforce.png" title="Figure 19: Obtaining the credentials of the user" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/rdpneg req.png" title="Figure 20: Viewing the RDP Negotiate Request" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/rdp neg res.png" title="Figure 21: Viewing the RDP Negotiate Response" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/tlshandshake.png" title="Figure 22: Viewing the Handshake and Termination of the Connection" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/evlwatcherf.png" title="Figure 23: Observing The Attackers IP-Address getting temporarily banned" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/disablentlm.png" title="Figure 24: Disabling NTLM authentication for all accounts" >}}
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/nontlm.png" title="Figure 25: Hydra failing without being able to use NTLM" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/lockout.png" title="Figure 26: Showing the lockout policy" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/payload.png" title="Figure 27: Showing the payload in the mp3 file" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/link_properties.png" title="Figure 28: Showing the properties of the mp3 file" >}}
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/listentiogn to the mp3 file.png" title="Figure 29: Listening to the mp3 file" >}}
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/exepayload.png" title="Figure 30: Executing the payload inside the mp3 file" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/sadgemimikatz.png" title="Figure 31: Running privilege::debug in mimikatz" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/dll-1.png" title="Figure 32: Opening a Messagebox with the dll" >}}
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex9/images/dll-2.png" title="Figure 33: Trying to run the script via the dll" >}}
...
## References
*For a full bibliography, see the [original BibTeX file](https://github.com/0xveya/goobering/blob/master/itsi/y3/ex9/zotero.bib).*
