...
> This is an HTL Donaustadt laboratory report converted from the original document. The [original PDF](https://github.com/0xveya/goobering/blob/master/itsi/y3/ex8/Sichere%20Datenspeicherung%20unter%20Windows.pdf) and [bibliography](https://github.com/0xveya/goobering/blob/master/itsi/y3/ex8/quellen.bib) are available on GitHub.
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/menAAA.png" title="Original report cover image" >}}
**Subject:** ITSI  
**Class:** 3AHITN  
**Name:** Veya Fürst, Justin Tremurici  
**Supervisor:** SPAC, ZIVK  
**Exercise dates:** 14.02.2025 | 21.02.2025 | 28.02.2025 | 07.03.2025  
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/expolicy.png" title="Figure 1: Listing the execution policies of the local machine" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/hostname.png" title="Figure 2: Verifying the hostname change" >}}
...
```powershell
$url = "https://raw.githubusercontent.com/0xveya/obsidianschule/refs/heads/main/3.Klasse/itsi/aufgaben/windoof/script.ps1"
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/tasksh.png" title="Figure 3: Inspecting the created task in task scheduler" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/fus-admin&&fus-user.png" title="Figure 4: Verifying the functionality of the two users" >}}
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/fus-net-user.png" title="Figure 5: Printing information about the users" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/Get-Partition.png" title="Figure 6: Printing the partition table" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/show spanning-tree.png" title="Figure 7: Printing the directory structure" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/lsr.png" title="Figure 8: Recursively listing the files" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/theVoices.png" title="Figure 9: Diagram of the users, groups and their permissions" >}}

---

##### Verifying the Creation of users and groups

{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/ds2.jpg" title="Figure 10: Showing all the groups" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/icals.png" title="Figure 11: Viewing the NTFS permissions of a directory" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/Get-SMBShare.png" title="Figure 12: Listing all the active SMB shares" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/nettest.jpg" title="Figure 13: Showing the groups that the test user is part of" >}}
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/nolocacc.jpg" title="Figure 14: Trying to access the directories locally on the drive" >}}
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/sharesadge.png" title="Figure 15: Trying to access a share that the user has no permission to open" >}}
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/readOnly.jpg" title="Figure 16: Trying to create a file in a directory where the user only has read permissions" >}}
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/rw.jpg" title="Figure 17: Creating a file in a directory where the user has read and write permissions" >}}
...
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/locked.jpg" title="Figure 18: Trying to list the contents of the encrypted volume" >}}
{{< figure src="https://raw.githubusercontent.com/0xveya/goobering/master/itsi/y3/ex8/images/unlock.jpg" title="Figure 19: Trying to list the contents of the encrypted volume after decrypting it" >}}

---

## References

*For a full bibliography, see the [original BibTeX file](https://github.com/0xveya/goobering/blob/master/itsi/y3/ex8/quellen.bib).*
